      ...
      <!-- <div class="c-panel-wrap"> -->
        ...
        <form method="POST" action="{{ route('steps.create') }}">
            ...
            <div class="c-form-group">
                ...
                <div class="">
                    <select id="category" class="form-control @error('category') is-invalid @enderror" name="category_id" value="{{ old('category') }}" required autocomplete="category" autofocus>
            ...
            <div class="c-form-group-submit">
                <button type="submit" name="cancel" class="c-button c-button-form p-button-accent3">
                    キャンセルする
                </button>
          </div>
        </form>

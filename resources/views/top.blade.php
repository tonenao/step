...
<div class="l-main-top p-page-top">
  ...
  <div class="p-container p-container--main">
    <div class="c-title">
          <h2 class="c-title__word">『STEP』概要</h2>
    </div>
    <div class="p-container p-container__body">
      ...
      <img  class="p-container__img" src="{{asset('/img/img1.jpg')}}">
      <br>
      ...
      <br>
      <div class="">
        <a class="p-container__link" href="#step">「模倣」って、なんか抵抗がある</a>
        <br>
        <a class="p-container__link" href="#share">「STEP」を共有しよう</a>
        <br>
        <a class="p-container__link" href="#challenge">「STEP」を使ってみよう</a>
      </div>

    </div>
  </div>

  <div class="p-container p-container--accent1">
    <div class="c-title">
          <h2 class="c-title__word" id="step">上達のコツは「模倣」にあり</h2>
    </div>
    <div class="p-container p-container__body">
      <p>「模倣する」という言葉には</p>
      ...
      <br>
      <p>「模倣すること」なのです。</p>
      <img  class="p-container__img" src="{{asset('/img/img2.jpg')}}">
      <p>時間が無限にあるのであれば、</p>
  ...
  <div class="p-container">
    <div class="c-title">
          <h2 class="c-title__word" id="share">共有しよう</h2>
    </div>
    <div class="p-container p-container__body">
      <p>もしも、あなたが試行錯誤の上に</p>
      <p>何らかの結果を達成したことがあれば</p>
      <p>その「順番」と「内容」を、STEPとしてぜひ共有してみてください。</p>
      <img  class="p-container__img" src="{{asset('/img/img3.jpg')}}">
  ...
  <div class="p-container p-container--main" style="margin-bottom:0;">
    <div class="c-title">
          <h2 class="c-title__word" id="challenge">使ってみよう</h2>
    </div>
    <div class="p-container p-container__body">
      <p>なんらかの達成したい目的があれば</p>
      <p>すでにそれを達成した人の「STEP」を辿ることが非常に有効です。</p>
      <img class="p-container__img" src="{{asset('/img/img4.jpg')}}">
